# 本仓库用于合并feature和factor,提前对feature进行padding
...
# 对feature数据进行padding处理
feature_data = pad_data(feature_data).reset_index()
print('完成对feature数据的padding处理')
# 为后续合并做准备，设置索引
...
# Step 5: 保存合并后的数据
merged_data.reset_index().to_parquet(f'../data/output/Fature_factor_data_{day}_master_n40.parquet')
